...
/**
 * Servlet implementation class IlanaBasvuruServlet
 */
@WebServlet("/IlanaBasvuruServlet")
public class IlanaBasvuruServlet extends HttpServlet {
	 ...
	 */
	public IlanaBasvuruServlet() throws UnknownHostException {
		super();
